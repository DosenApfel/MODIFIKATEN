...
public class Crusher extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(Main.MODID + ":" + "CrusherSide");
		this.iconFront = iconRegister.registerIcon(Main.MODID + ":" + (this.isActive ? "CrusherFrontOn" : "CrusherFrontOff"));
		this.iconTop = iconRegister.registerIcon(Main.MODID + ":" + "CrusherTop");
	}
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(BasicBlocks.blockCrusherIdle);
}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, Main.instance, BasicBlocks.guiIDCrusher, world, x, y, z);
		}
	    return true;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityplayer, ItemStack itemstack) {
		...
		if(itemstack.hasDisplayName()) {
			((TileEntityCrusher)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
		}
	}
	...
	public static void updateAlabasterOvenBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, BasicBlocks.blockCrusherActive);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, BasicBlocks.blockCrusherIdle);
		}
