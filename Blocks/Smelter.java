...
public class Smelter extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(Main.MODID + ":" + "SmelterSide");
		this.iconFront = iconRegister.registerIcon(Main.MODID + ":" + (this.isActive ? "SmelterFrontOn" : "SmelterFrontOff"));
		this.iconTop = iconRegister.registerIcon(Main.MODID + ":" + "SmelterTop");
	}
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(BasicBlocks.blockSmelterIdle);
}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, Main.instance, BasicBlocks.guiIDSmelter, world, x, y, z);
		}
	    return true;
	}
	...
	public static void updateAlabasterOvenBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, BasicBlocks.blockSmelterActive);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, BasicBlocks.blockSmelterIdle);
		}
